...
public class SoalSatu {
    ...
    private int m1, m2;
    private int s1, s2;
    private double biaya, lama, ubah;
    ...
    //pada soal 5 detik seharga 150 rupiah, sehingga 1 detik seharga 30 rupiah
    public double getBiaya(){
        return getLama() * 30;
    }
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        SoalSatu biaya = new SoalSatu();
        ...
        //menampilkan jam awal dan akhir dalam tampilan (hh:mm:ss)
        System.out.println("\n\nJam awal anda berbicara yaitu pukul " +biaya.getH1()+ ":" +biaya.getM1()+ ":" +biaya.getS1());
        System.out.println("Jam akhir anda berbicara yaitu pukul " +biaya.getH2()+ ":" +biaya.getM2()+ ":" +biaya.getS2());

        // menampilkan lama percakapan juga biaya percakapan
        System.out.println("Sehingga, lama percakapan anda yaitu " +biaya.getUbah() + " jam");
        System.out.println("Dengan biaya percakapan anda sebesar Rp " + biaya.getBiaya());
    }
}
